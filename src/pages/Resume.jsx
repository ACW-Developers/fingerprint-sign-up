...
const Resume = () => {
  return (
    <div className="h-full page-shadow bg-white p-4 sm:p-5">
      {/* Education Section */}
      <section className="education mb-4">
        <div className="flex items-center mb-2">
          <MdSchool className="text-xl sm:text-2xl text-primary mr-2" />
        ...
        <div className="space-y-3">
          <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-start">
              <FaUniversity className="text-base sm:text-lg text-gray-500 mt-1 mr-2 flex-shrink-0" />
              <div>
                <h3 className="text-sm sm:text-base font-bold text-gray-700">Kisii University, Kenya</h3>
                <p className="text-xs text-gray-500"> Bachelor of Science in Information Technology <b><i>(Second Upper)</i></b>
                (2020 - 2024)</p>
      ...
      <section className="work-experience">
        <div className="flex items-center mb-2">
          <MdWork className="text-xl sm:text-2xl text-primary mr-2" />
          <h2 className="text-base sm:text-lg font-semibold text-gray-800">Work Experience</h2>
        </div>
        <div className="space-y-3">
          <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-start">
              <FaLaptopCode className="text-base sm:text-lg text-gray-500 mt-1 mr-2 flex-shrink-0" />
              <div>
                ...
                <p className="text-xs text-gray-500">May 2024 - Till Date</p>
                <p className="text-gray-600 mt-1.5 text-xs sm:text-sm">
          ...
          <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex items-start">
              <FaUsers className="text-base sm:text-lg text-gray-500 mt-1 mr-2 flex-shrink-0" />
              <div>
                <h3 className="text-sm sm:text-base font-bold text-gray-700">
                  ICT Support - <a href="#" className="text-primary hover:underline">County Government of Trans-Nzoia, Kenya</a>
                </h3>
                <p className="text-xs text-gray-500">2023 – 2023</p>
                <p className="text-gray-600 mt-1.5 text-xs sm:text-sm">
