...
<div className="px-12 py-6 space-y-4">
  ...
  <p className="text-black/75 font-semibold text-left">A Fullstack Developer</p>
  ...
  <a className="inline-block bg-purple-400 primary-btn" href="mailto:amosclinton196@gmail.com">Get in Touch</a>
</div>
